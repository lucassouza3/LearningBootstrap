      ...
      <footer className={episode ? styles.empty : ''}>
        <div className={styles.progress}>
          ...
          <div className={styles.slider}>
            ...
            {episode ? (<Slider trackStyle={{ backgroundColor: '#04d361' }} railStyle={{ backgroundColor: '#9f75ff' }} handleStyle={{ borderColor: '#04d361', borderWidth: 4 }} />) : (<div className={styles.emptySlider} />)}
